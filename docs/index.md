...
!!! custom inline end ""
    ...
    <a href='https://graphole.com' target='_blank' title='Graphole'><span class='favicon-inline'></span></a> [graphole.com](https://graphole.com){:target='_blank'}<br>
    [:material-file-download-outline:](./assets/doc/cv-professor.pdf){:download title='Academic CV (PDF)'} [Academic CV](./assets/doc/cv-professor.pdf){:download} · [Developer résumé](./assets/doc/cv-developer.pdf){:download title='Developer résumé (PDF)'}
